  ...
  <! Banner --> 
         <table role="presentation" width="100%">
            <tr>
             ...
             <img alt="Flower" src="{{asset('assets/LogoO.png')}}" width="400px" align="middle">
                
                <h1> Hi!  {{"MIE Consultant Teaam"}}</h1>
      ...
      <tr>
         ...
         <h2> Nullam porta arcu </h2>
          ...
          <td style="padding-left: 20px !important;"> 
            <h5>Enquiery user Details</h5>
           <strong>Name:</strong> {{$name}} <br/><strong>Email:</strong> {{$email1}} <br/></td>
  ...
  <table role="presentation" bgcolor="#F5F8FA" width="100%" >
      <tr>
          <td align="left" style="padding: 30px 30px;">
            <p style="color:#99ACC2"> Made with &hearts; at MIE Consultant </p>
