@extends('layoutAdmin.master')
 @section('title') Admin|Country Visitor @endsection 
 @section('main-content')

<div class="bg-body-light">
	<div class="content content-full">
		<div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
			<h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Country Visitor</h1>
			<nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item">Dashboard</li>
					<li class="breadcrumb-item active" aria-current="page">Country Visitor</li>
				</ol>
			</nav>
		</div>
	</div>
...
<div class="block-content">
	<div class="block block-rounded">
		<div class="block-header block-header-default">
			<h3 class="block-title">Country Visitor</h3> </div>
...
$(document).ready(function() {
            var table = $('.datatable').DataTable({
                ...
                responsive:true,
                serverSide: true,
                ajax: "{{ route('country.visitordatatable') }}",
                columns: [
