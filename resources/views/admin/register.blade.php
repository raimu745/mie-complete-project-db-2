...
<html lang="en">
 ...
 <link rel="shortcut icon" href="{{asset('assets/media/favicons/favicon.png')}}">
    ...
    <style>
      .bg-image{
        background-image: url({{asset('assets/3.jpg')}});
      }
      </style>
      </head>
    <body>
        ...
        <div id="page-container">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image">
                    <div class="row no-gutters justify-content-center bg-black-25">
                                ...
                                <div class="block-content block-content-full px-lg-5 px-xl-6 py-4 py-md-5 py-lg-6 bg-white">
                                    ...
                                    <div class="mb-2 text-center">
                                        <a class="link-fx text-success font-w700 font-size-h1" href="index.html">
                                            <span class="text-dark">M</span><span class="text-primary">IE</span>
                                        </a>
                                        <p class="text-uppercase font-w700 font-size-sm text-muted">Create New Account</p>
                                    </div>
                                    <!-- END Header -->

                                    <form  action="{{route('re.store')}}" method="POST" enctype="multipart/form-data">
                                     @csrf()  
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                                ...
                                                <input type="file" class="custom-file-input" data-toggle="custom-file-input"  name="image">
                                                <label class="custom-file-label">Choose a profille picture</label>
                                            </div>
                                            @error('image')
                                             <div class="alert alert-danger">{{$message}}</div>
                                                @enderror
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <br><br>
                                              <div style="text-align: center !important;">
                                                    <a href="{{route('login')}}" style="text-align: center !important;text-decoration:underline">SignIn</a>
                                                </div>
                                        </div>
                                    </form>
                                    <!-- END Sign Up Form -->
