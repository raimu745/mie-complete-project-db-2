...
<form action="{{route('country.updatedes',['id'=>encrypt($edit->id)])}}" method="POST" enctype="multipart/form-data" id="contactForm" class="dropzone">
    @csrf()
    <div class="content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Enter a name.." value="{{old('title',$edit->title ?? '')}}">
                            @error('title')
                    ...
                    <div class="col-md-6">
                            ...
                            <select class="form-control select"  name="country_id">
                                ...
                                <option value="{{$country->id}}" {{ $edit->country_id == $country->id ? 'selected' : '' }}>{{$country->name}}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="intake" placeholder="Enter a name.." value="{{old('intake',$edit->intake ?? '')}}">
                            @error('intake')
                            <div class="alert alert-danger">{{$message}}</div>
                            @enderror
                        </div>
