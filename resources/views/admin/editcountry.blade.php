                ...
                <div class="row">
                    <div class="col-md-6">  
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{old('name',$country->name ?? '')}}" placeholder="Enter a name..">
                            @error('name')
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <!-- <div class="form-group">
                            ...
                            <img src="{{asset('assets/uploads/country/'.$country->image)}}" id="preview" class="img-responsive browse" style="    height: 100px;">
                            @error('image')
                            <div class="alert alert-danger">{{$message}}</div>
                            @enderror
                        </div> -->
                        <div class="add-more">
							...
							<p id="files-area">
								<span id="filesList">
									<span id="files-names">
                                        @foreach ($country->images as $new)
										<a href="{{url('admin/countrysingledelete',['id'=>encrypt($new->id)])}}">   <span class="file-block"><span class="file-delete"><span>x</span></span><span class="name">{{$new->image}}</span></span></a>
                                    </span>
                                     @endforeach
								</span>
							</p>
