        ...
        <div class="col-lg-6 contact-left">
          <div class="partners">
            ...
            <div class="hours">
              ...
              <p class="margin-top"><a href="tel:{{$contact->phone_nbr}}">{{$contact->phone_nbr}}</a></p>
            </div>
          </div>
        </div>
        <div class="col-lg-6 mt-lg-0 mt-5 contact-right">
        @if(Session::has('success'))
      <div class="alert  alert-success">Thanks yours enquiry lock and the MIE team will response you  soon.</div>
        @endif
          <form action="{{route('save_contact_site.index')}}" method="post" class="signin-form">
            @csrf()
            <div class="input-grids">
              ...
              <div class="form-group">
                <input type="email" name="eamil1" id="w3lSender" placeholder="Your Email*" class="contact-input" required="" />
              </div>
              <div class="form-group">
                <input type="phone" name="phone" id="w3phone" placeholder="Your Phone Number*" class="contact-input" required="" />
              </div>
              <div class="form-group">
            ...
            <div class="text-right">
              <button class="btn btn-style btn-primary" type="submit">Send Message</button>
            </div>
          </form>
        </div>
